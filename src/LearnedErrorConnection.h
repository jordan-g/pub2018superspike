...
#ifndef LEARNEDERRORCONNECTION_H_
#define LEARNEDERRORCONNECTION_H_
...
class LearnedErrorConnection : public SparseConnection
{
private:
...
public:
	...
	LearnedErrorConnection(SpikingGroup * source, NeuronGroup * destination, 
			AurynWeight weight, AurynFloat sparseness=0.05, 
			TransmitterType transmitter=GLUT, string name="LearnedErrorConnection");

	virtual ~LearnedErrorConnection();
